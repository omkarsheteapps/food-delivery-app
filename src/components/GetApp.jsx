...
const GetApp = () => {
  return (
    <section className=" dark:bg-black py-10 transition-colors duration-300">
      <div className=" bg-red-100 dark:bg-[#1F1D2B] py-16 px-6 lg:px-20 rounded-3xl mx-4 lg:mx-16">
        <div className="grid md:grid-cols-2 items-center gap-10">
          ...
          <div>
            ...
            <button className="bg-red-500 text-white font-medium px-6 py-3 rounded-full shadow hover:bg-red-600 transition">
              Get the app
            </button>
          </div>
